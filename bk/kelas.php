...
$id = $_GET["id"];
$query = mysqli_query($conn, "SELECT * FROM siswa WHERE status = 'Pasif' AND kls LIKE  '%$id%' ORDER BY nis ASC");
...
<div class="col-md-10 mt-3">
 ...
 <table class="table table-hover">
    ...
    <tr>
      ...
      <td class="hidden text-center"><a href="siswa_edit.php?id=<?=$row["id_siswa"]; ?>">O</a> <br><a href="siswa_aktif.php?id=<?=$row["id_siswa"]; ?>&kls=<?=$id;?>"><?=$row["status"]; ?></a><br><a href="siswa_reset.php?id=<?=$row["id_siswa"]; ?>&kls=<?=$id;?>" onclick = "return confirm('yakin ?');">Reset</a><br></td>
    </tr>
    <?php $s++;?>
   <?php endwhile; ?>
</table>
