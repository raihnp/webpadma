...
if(isset($_POST["search"])) {
      ...
      $sql = mysqli_query($conn, "SELECT * FROM siswa WHERE switch ='on' AND kls LIKE '%$kls%' ORDER BY nis asc LIMIT $mulai,$halaman"); 
      $sql2 = mysqli_num_rows($sql);
      $sq= mysqli_query($conn, "SELECT * FROM siswa WHERE switch ='on'");
      $sql3 = mysqli_num_rows($sq);   
    }
...
<div class="form p-1">
      ...
      <span style="font-size: 20px">Database Siswa Kelas <?=$k;?> [<a href="absensi_db.php?k=<?=$k;?>">Absensi</a>]</span>
 ...
 <table class="table table-hover">
    ...
    <tr>
      ...
      <td></td>
      <td>
        <table class="table-sm" style="line-height: 1em;">
          <tr>
            <td>Telpon</td>
            <td>:</td>
            <td></td>
      ...
      <td class="hidden"><a href="siswa_edit.php?id=<?=$row["id_siswa"];?>">O</a><br><a href="siswa_pilihan_edit.php?id=<?=$row["id_siswa"];?>">Exstra</a><br><a href="nilai.php?id=<?=$row["id_siswa"];?>&n=<?=$row["siswa"];?>&k=<?=$k;?>">Nilai</a><br><a href="ortu_cab.php?nis=<?=$row["nis"];?>&nama=<?=$row["siswa"];?>&kls=<?=$k;?>">Ortu</a></td>
    </tr>
   <?php endwhile; ?>
</table>
