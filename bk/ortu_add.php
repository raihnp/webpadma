       ...
       if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
          if($ukuran < 500000){
           ...
           $move = move_uploaded_file($foto_tmp, '../img/ortu/'.$filefotoBaru);
              ...
              document.location.href = 'ortu_db.php';</script>";}
        $query = "INSERT INTO ortu VALUES ('', '$ortu', '$nis', '$tempat', '$tanggal', '$jk', '$ktp', '$agama', '$alamat', '$telpon', '$email', '$line', '$foto', '$catatan')";
...
<html lang="en">
  ...
  <body>
   ...
   <!-- -------------- -->
   <div class="form">  
            <h4 style="margin: 0px">FORM Orang Tua/ Wali <?=$nama;?> | <?=$kls;?></h4>
         <hr>
    <form method="POST" action="" enctype="multipart/form-data">     
    <div class="row">
      <div class="col-md-9">
        <div class="form-group">
           <label for="ortu" class="control-label">Nama Lengkap Orang Tua/ Wali</label>
