...
if(isset($_POST["simpan"])){
        ...
        if($ukuran < 500000){
         ...
         $move = move_uploaded_file($foto_tmp, '../img/alumni/'.$filefotoBaru);
                if($move){$foto = $filefotoBaru; 
                      ...
                      document.location.href = 'alumni_db.php';</script>";}
              }else{echo"<script>
                    alert('Data gagal ditambahkan ... Ekstensi Foto yang diperbolehkan png dan jpg');
                    document.location.href = 'alumni_db.php';</script>";}
                   
                $query = "INSERT INTO alumni VALUES ('', '$alumni', '$nis', '$lulus', '$jk', '$tempat', '$tanggal', '$alamat', '$agama', '$telpon', '$email', '$line', '$foto', '$catatan')";
  ...
  if (mysqli_affected_rows($conn) > 0) {
    ...
    document.location.href = 'alumni_db.php';
    </script>
    ";
  } else {
    echo"
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="form-group">
           ...
           <input type="text" name="alumni" value="" class="form-control" id="alumni" autocomplete="off">
        </div>
      </div>
      <div class="col-md-2">
        <div class="form-group">
      ...
      <div class="col-md-2">
        <div class="form-group">
           <label for="lul" class="control-label">Lulus</label>
            <input type="text" name="lulus" value="" class="form-control" id="lul" autocomplete="off">
        </div>
      </div>
    </div>
    <div class="row">
