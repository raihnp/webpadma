  ...
  <body>
    ...
    <div class="col-md-12">
        <div class="container-fluid">
          ...
          <div role="main" class="home">
             <div>
              <h2 class="animated infinite pulse" style="margin-top: -100px"><b>Padmanaba</b></h2>
              <p class="intro">Yogyakarta</p>
             </div>
          </div>
        </div>
        <div class="d-none d-sm-block">
          <img src="img/rame.jpg" style="display: block; margin-left: auto;margin-right:auto;">
       </div>
       <div class=" d-sm-none d-md-block‘ d-md-none d-lg-block‘ ">
        <img src="img/rame2.jpg" style="display: block; margin-left: auto;margin-right:auto;">
      </div>
     </div>
     </div>
   </div>
   <nav class="navbar fixed-bottom navbar-light text-center">
      <span class="navbar-text mx-auto d-block">
        <a href="javascript:history.back()">[Opti<a style="color: red">on</a>]</a> | <a href="javascript:history.back()">Build <?php echo tglIndonesia(date('F Y')); ?></a>
      </span>
    </nav>
