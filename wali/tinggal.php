...
$id = $_GET["id"];
$sq = mysqli_query($conn, "SELECT * FROM siswa WHERE id_siswa = '$id'");
$ss= mysqli_fetch_assoc($sq);
$x = $ss["klsx"];
...
if(isset($_POST["simpan"])){
 ...
 if(empty($x)){
  ...
  $kls = 'KELUAR'.'/'.$tgl;
   $query = "UPDATE siswa SET kls = '$kls' WHERE id_siswa = '$id'";
   mysqli_query($conn, $query);
  echo "<script>
        alert('Keluar');
...
<div class="col-md-10 mt-3">
    <!-- ------------ -->
    <div class="form">
           <p style="font-size: 20px; margin: 0px"><b>Tinggal Kelas</b></p>
           <hr>
          ...
          <div class="row">
           <div class="col-md-3">
             ...
             <div class="col-md-3">
              <div class="form-group">
                 <label for="tinggal" class="control-label">Tinggal di kelas</label>
                 <input type="hidden" name="tinggal" value="<?=$y; ?>">
                 <input type="text" name="" value="<?=$y; ?>" class="form-control" id="tinggal" disabled >
              </div>
            </div>
              <div class="col-md-3">
                <div class="form-group">
