...
$sqlx = mysqli_query($conn, "SELECT id_guru, guru, jabatan, pelajaran, status, foto FROM guru WHERE id_guru = '$id_guru'");
$rowx = mysqli_fetch_assoc($sqlx);
$guru = $rowx["guru"];
$jabatan = $rowx["jabatan"];
$kel = explode(" ", $jabatan);
$kelas = $kel[2]." ".$kel[3]." ".$kel[4];
            ...
            <div class="card-header text-center" style="font-size: 14px;">
             <?= $jabatan; ?><br><?= $pelajaran; ?>
              ...
              <ul>
               ...
               <li><a href="wali_kelas.php?id=<?=$kelas;?>"><?=$kelas;?></a></li>
                <li><a href="soal_db.php">SoalDb</a></li>
                ...
                <li><a href="guru_pass.php">Password</a></li>
              </ul>
          </div>
        </div>
        </div>
