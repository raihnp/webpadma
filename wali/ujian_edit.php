...
if(isset($_POST["submit"])){
  ...
  $icons = $_POST["icons"];
     $query = "UPDATE kalender SET date = '$date', title = '$title', description = '$description', kls = '$kls', user = '$user', icons = '$icons', keterangan = '$keterangan' WHERE id_kalender = '$id'";
...
<div class="col-md-10 mt-3">
    <!-- ------------ -->
<div class="form">
  <p style="font-size: 20px; margin-top: 25px"><b>Form Ujian</b></p>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
           <label for="icons" class="control-label">Status</label><br>
           <input type="radio" name="icons" value="launch" <?php if($ka["icons"]=='launch'){echo 'checked';}?>>online |
           <input type="radio" name="icons" value="" <?php if($ka["icons"]==''){echo 'checked';}?>>offline
        </div>
    </div>
  </div>
      <div class="form-group">
