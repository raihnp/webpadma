...
if(isset($_POST["simpan"])){
 ...
 if ($y == 'XII'){
  ...
  $query = "UPDATE siswa1 SET kls = '$kls', klsb = '$klsb', klsc = '$klsc', klsd = '$klsd', klsx = '$klsx', note = '$note' WHERE id_siswa = '$id'";
...
<div class="col-md-10 mt-3">
    <!-- ------------ -->
    <div class="form">
    <p style="font-size: 20px; margin: 0px"><b>Pindah Sekolah</b></p>
           <hr>
          ...
          <div class="row">
           <div class="col-md-3">
              ...
              <div class="form-group">
                  <label for="catat" class="control-label">Alasan kepindahan</label>
                  <textarea class="ckeditor" name="note" id="catat" class="form-control" ></textarea>
            </div>
            <div class="row">
              <div class="col-md-3 offset-md-9">
                <div class="form-group">
                   <label for="tgl" class="control-label">Tanggal ditetapkan</label>
         ...
         <hr>
         <input type="submit" name="simpan" class="btn btn-outline-dark" value="Rubah" disabled />
