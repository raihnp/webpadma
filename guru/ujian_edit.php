...
<div class="col-md-10 mt-3">
    <!-- ------------ -->
<div class="form">
  <p style="font-size: 20px"><b>Form Ujian</b></p>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
           <label for="ol" class="control-label">Status</label><br>
           <input type="radio" name="ol" value="online" <?php if($row["ol"]=='online'){echo 'checked';}?>>Laki-laki |
           <input type="radio" name="ol" value="offline" <?php if($row["ol"]=='offline'){echo 'checked';}?>>offline
        </div>
    </div>
  </div>
      <div class="form-group">
