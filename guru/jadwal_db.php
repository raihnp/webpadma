...
<html lang="en">
  ...
  <body>
   <div class="container">
    ...
    <!-- ------------ -->
      <div class="container">
      <p style="font-size: 20px"><b>Jadwal Pelajaran</b></p>
      <?php while($row=mysqli_fetch_assoc($sql)):?>
      <div class="kotak"><a href="jadwal_kelas.php?kls=<?=$row["kelas"]; ?>"><b><?=$row["kelas"]; ?></b></a></div>
      <?php endwhile; ?>
      <div class="row clear">
          <p style="font-size: 20px; margin-top: 50px;"><b>Jadwal Guru Piket</b></p>
      </div>
      <div class="row">
      <div class="col-md">
