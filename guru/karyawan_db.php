...
if(isset($_POST["search"])) {
      ...
      $sql = mysqli_query($conn, "SELECT * FROM karyawan WHERE status != 'Inbox' AND code LIKE '%$keyword%' OR karyawan LIKE '%$keyword%' OR jabatan LIKE  '%$keyword%'OR pelajaran LIKE '%$keyword%'ORDER BY code asc");
      $sql2 = mysqli_num_rows($sql);
      $sq= mysqli_query($conn, "SELECT * FROM karyawan WHERE status != 'Inbox'");
