...
$sql = mysqli_query($conn, "SELECT * FROM kelas LIMIT 1,22");
?>
<!doctype html>
<html lang="en">
  <head>
...
<div class="col-md-10">
    <!-- ------------ -->
    <p style="font-size: 20px; margin-top: 25px;"><b>Jadwal Pelajaran</b></p>
      <?php while($row=mysqli_fetch_assoc($sql)):?>
      <div class="kotak"><a href="jadwal_kelasa.php?kls=<?=$row["kelas"]; ?>&hari=<?=hari();?>"><b><?=$row["kelas"]; ?></b></a></div>
      <?php endwhile; ?>
   <!-- -------------- -->
</div>
