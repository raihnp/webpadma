...
$t[] = $row["t"];
endwhile;
$sql1 = mysqli_query($conn, "SELECT * FROM absen WHERE kelas = '$kls' AND t = '1' AND tanggal = '$tgl'"); $row1 = mysqli_fetch_assoc($sql1);
$sql2 = mysqli_query($conn, "SELECT * FROM absen WHERE kelas = '$kls' AND t = '2' AND tanggal = '$tgl'"); $row2 = mysqli_fetch_assoc($sql2);
$sql3 = mysqli_query($conn, "SELECT * FROM absen WHERE kelas = '$kls' AND t = '3' AND tanggal = '$tgl'"); $row3 = mysqli_fetch_assoc($sql3);
$sql4 = mysqli_query($conn, "SELECT * FROM absen WHERE kelas = '$kls' AND t = '4' AND tanggal = '$tgl'"); $row4 = mysqli_fetch_assoc($sql4);
$sql5 = mysqli_query($conn, "SELECT * FROM absen WHERE kelas = '$kls' AND t = '5' AND tanggal = '$tgl'"); $row5 = mysqli_fetch_assoc($sql5);
$sql6 = mysqli_query($conn, "SELECT * FROM absen WHERE kelas = '$kls' AND t = '6' AND tanggal = '$tgl'"); $row6 = mysqli_fetch_assoc($sql6);
$sql7 = mysqli_query($conn, "SELECT * FROM absen WHERE kelas = '$kls' AND t = '7' AND tanggal = '$tgl'"); $row7 = mysqli_fetch_assoc($sql7);
$sql8 = mysqli_query($conn, "SELECT * FROM absen WHERE kelas = '$kls' AND t = '8' AND tanggal = '$tgl'"); $row8 = mysqli_fetch_assoc($sql8);
$sql9 = mysqli_query($conn, "SELECT * FROM absen WHERE kelas = '$kls' AND t = '9' AND tanggal = '$tgl'"); $row9 = mysqli_fetch_assoc($sql9);
$sql10 = mysqli_query($conn, "SELECT * FROM absen WHERE kelas = '$kls' AND t = '10' AND tanggal = '$tgl'"); $row10 = mysqli_fetch_assoc($sql10);
?>
<!doctype html>
<html lang="en">
  <head>
...
<div class="col-md-10">
    ...
    <div class="container">
            ...
            <div class="hidden-xs hidden-xm"><p style="text-align: right; padding-right: 10px;"><i><?=$tg; ?></i>&nbsp;&nbsp;&nbsp;<a href="absensi_cetak.php?kls=<?=$kls;?>&tgl=<?=$tgl;?>"> <span class="glyphicon glyphicon-print" aria-hidden="true"></span></a>&nbsp;&nbsp;&nbsp;<a href="record.php"> <span class="glyphicon glyphicon-record" aria-hidden="true"></span></a></p></div>
            <table class="table table-striped table-bordered table-list">
              ...
              <tr>
                ...
                <td>
                 <?php
                  $cob = mysqli_query($conn, "SELECT siswa.id_siswa, siswa.siswa, siswa.nis, siswa1.id_siswa, siswa1.kls FROM siswa JOIN siswa1 ON siswa.id_siswa = siswa1.id_siswa WHERE siswa1.kls LIKE '%$kls%' ORDER BY siswa.nis asc");?>
                  <?php if(!empty($t)){
