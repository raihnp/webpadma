...
<html lang="en">
  ...
  <body>
   <div class="container-liquit">
    ...
    <div class="container"> 
        ...
        <p><a class="btn btn btn-<?=$kal;?> btn-sm" href="kalender_db.php" role="button">KalendeDb</a>  <a class="btn btn-<?=$info;?> btn-sm" href="doc_k_db.php" role="button">InfoDb</a>  <a class="btn btn-<?=$ujian;?> btn-sm" href="ujian_db.php" role="button">Ujian</a>  <a class="btn btn-<?=$tugas;?> btn-sm" href="tugas_db.php" role="button">Tugas</a>  <a class="btn btn-<?=$nilai;?> btn-sm" href="nilai.php" role="button">Nilai</a>  <a class="btn btn-<?=$masuk;?> btn-sm" href="doc_m_db.php" role="button">SuratDb</a></p>
    <br>
 ...
 <div class="col-md mt-2">
   ...
   $pik = mysqli_fetch_assoc($piket); ?>
        ...
        <p style="font-size: 20px; margin: 0px"><b> Guru Piket</b> hari ini</p> <?= $tanggal ?> <br><a href="jadwal_dba.php?id=<?=$pik["guru1"]; ?>"><?=$pik["guru1"]; ?></a> | <a href="jadwal_dba.php?id=<?=$pik["guru2"]; ?>"><?=$pik["guru2"]; ?></a> | <a href="jadwal_dba.php?id=<?=$pik["guru3"]; ?>"><?=$pik["guru3"]; ?></a> | <a href="jadwal_dba.php?id=<?=$pik["guru4"]; ?>"><?=$pik["guru4"]; ?></a> | <a href="jadwal_dba.php?id=<?=$pik["guru5"]; ?>"><?=$pik["guru5"]; ?></a> | <a href="jadwal_dba.php?id=<?=$pik["guru6"]; ?>"><?=$pik["guru"]; ?></a>
        <hr style="border-color: black">
    </div>
   <!-- -------------- -->
 </div>
