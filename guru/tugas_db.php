...
<div class="col-md-10 mt-3">
    ...
    <div class="card p-1" style="width: 100%;">
      ...
      <span style="font-size: 20px">Database Tugas</span>
  ...
  <table class="table table-hover">
       ...
       <?php $date = $row["tanggal"]; 
         ...
         ?>
          <tr>
            <td><?= $s; ?></td>
            <td class="hidden2"><?= $tgl; ?><br><i><?=$row["kls"]; ?></i></td>
            <td class="hidden"><?= $tgl; ?></td>
            <td class="hidden"><?=$row["kls"]; ?></td>
            <td class="hidden2"><?=$row["judul"]; ?><br><i><?=$row["keterangan"]; ?></i></td>
            <td class="hidden"><?=$row["judul"]; ?></td>
            <td class="hidden"><?=$row["keterangan"]; ?></td>
            <td class="hidden text-center" "><a href="tugas_edit.php?id=<?=$row["id_tugas"]; ?>">O</a></td>  
            <?php $s++; ?>
          </tr>
        <?php endwhile; ?>  
        </table>
