...
<!--
function fullwin(){
window.open("ol.php?id=<?=$id;?>","","fullscreen,scrollbars")
}
//-->
</script>
   
<div class="text-center" style="margin-top: 200px;">
    <h3>Setelah tombol "mulai" ditekan halaman soal akan terbuka dan hitung mundur di mulai.</h3><br>
          <a onClick="fullwin()"
            class="btn btn btn-outline-dark">Mulai</a>
  </div> 
   <!-- -------------- -->
</div>
