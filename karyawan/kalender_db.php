...
$sqlx = mysqli_query($conn, "SELECT id_karyawan, karyawan, jabatan, status, foto, kal, info FROM karyawan WHERE id_karyawan = '$id_karyawan'");
$rowx = mysqli_fetch_assoc($sqlx);
$karyawan = $rowx["karyawan"];
$jabatan = $rowx["jabatan"];
$foto = $rowx["foto"];

$qu = "UPDATE karyawan SET kal ='outline-primary' WHERE id_karyawan = '$id_karyawan'";
