...
if(isset($_POST["search"])) {
      ...
      $sql = mysqli_query($conn, "SELECT * FROM karyawan WHERE status != 'Inbox' AND code LIKE '%$keyword%' OR karyawan LIKE '%$keyword%' OR jabatan LIKE  '%$keyword%' ORDER BY code asc");
      $sql2 = mysqli_num_rows($sql);
      $sq= mysqli_query($conn, "SELECT * FROM karyawan");
      $sql3 = mysqli_num_rows($sq);
      $no = 1;
  }else{
      $sql = mysqli_query($conn, "SELECT * FROM karyawan WHERE status != 'Inbox' ORDER BY code asc LIMIT $mulai,$halaman"); 
      $sql2 = mysqli_num_rows($sql);
      $sq= mysqli_query($conn, "SELECT * FROM karyawan");
      $sql3 = mysqli_num_rows($sq);   
    }
  ...
  <body>
   <div class="container">
    ...
    <div class="form p-1">
      ...
      <span style="font-size: 20px">Database Karyawan</span>
