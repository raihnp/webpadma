...
if(isset($_POST["submit"])){
          ...
          if($ukuran < 500000){
           ...
           $move = move_uploaded_file($foto_tmp, '../img/siswa/'.$filefotoBaru);
              if($move){$foto = $filefotoBaru; 
                ...
                document.location.href = 'siswa_db.php';</script>";}
        }else{echo"<script>
  ...
  $catatan = $_POST["catatan"];
        $query = "INSERT INTO siswa VALUES ('','$siswa','$code','$nis','$jk','$tempat',        '$tanggal','$alamat','$agama','$telpon','$email','$line','$foto','$status','$kal','$info','$kls','$klsb','$klsc','$klsd','$klsx','$klsn','$ujian','$tugas','$nilai','$tu','$perpus','$j_hari','$hadir','$sakit','$ijin','$xxx','$switch','$catatan')";
        mysqli_query($conn, $query);
  $id_guru = '';
  $id_karyawan = '';
  $id_siswa =  mysqli_insert_id($conn);
  $cod = 's'.$id_siswa;
  $query1 = "UPDATE siswa SET code = '$cod' WHERE id_siswa = '$id_siswa'";
...
<html lang="en">
  ...
  <body>
   ...
   <!-- -------------- -->
   <div class="form">  
            <h3 style="margin: 0px">FORM Siswa</h3>
         <hr>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
           ...
           <input type="text" name="siswa" value="" class="form-control" id="siswa" autocomplete="off">
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="form-group">
           ...
           <input type="text" name="tempat" value="" class="form-control" id="tempat" autocomplete="off">
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
           <label for="Tanggal" class="control-label">Tanggal Lahir</label>
           <input type="date" name="tanggal" value="" class="form-control" id="tanggal" >
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
           ...
           <input type="textarea" name="alamat" value="" class="form-control" id="ala_siswa" autocomplete="off">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
           ...
           <input type="text" name="telpon" value="" class="form-control" id="tel_siswa" autocomplete="off">
        </div>
      </div>
      <div class="col-md-4">
        <div class="form-group">
           <label for="email" class="control-label">e-mail</label>
           <input type="text" name="email" value="" class="form-control" id="email" autocomplete="off">
        </div>
      </div>
      <div class="col-md-4">
        <div class="form-group">
           <label for="line" class="control-label">line</label>
           <input type="text" name="line" value="" class="form-control" id="line" autocomplete="off">
        </div>
      </div> 
    </div> 
    <div class="row">
