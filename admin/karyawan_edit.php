  ...
  <body>
   ...
   <div class="form">  
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="form-group">
           ...
           <input type="text" name="nik"  class="form-control" id="nip" value="<?=$row['nik']; ?>" autocomplete="off">
        </div>
      </div> 
    </div>
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="form-group">
           ...
           <input type="date" name="tanggal" class="form-control" value="<?=$row['tanggal']; ?>" id="tanggal" autocomplete="off">
        </div>
      </div> 
      <div class="col-md-3">
        <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
           <label for="tel_guru" class="control-label">Telpon</label>
