...
if(isset($_POST["submit"])){
  ...
  $filefoto = $_FILES["filefoto"]["name"];
   ...
   $query = "UPDATE web SET img1 = '$foto', story = '$story' WHERE id_web ='1'";
    ...
    <div class="form p-1">
      ...
      <form method="POST" action="" enctype="multipart/form-data">
          <div class="row mt-2 pl-2">
            <div class="col-md-4">
                <img src="../img/web/<?=$row["img1"]; ?>" width = "200px"><br><i>Terpasang</i>
            </div>
            <div class="col-md-8">
              <div class="form-group">
                <i>Ganti</i>
                 <input type="file" name="filefoto" value="" class="form-control" id="filefoto">
                  <input type="hidden" name="fotolama" value="<?=$row["img1"]; ?>">
              </div>
            </div>
          </div>
        <div class="row">
          <div class="col-md-2">
              <?php 
                ...
                <?php }else{
                   if(preg_match("/youtube/", $row['story'])) {;?>
                      <div class="embed-responsive embed-responsive-16by9">
                        <?=$row['story'];?>
                      </div>
                    <?php } else {echo $row['story'];}
                } ?>
            </div>
          ...
          <div class="form-group">
            <i>Ganti Video</i>
            <div class="form-group">
              <textarea  name="story" id="ket" class="form-control" ><?=$row["story"]; ?></textarea>
            </div>
          </div>
        </div>
        </div>
...
<!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/NZ9fcd5fuqg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->