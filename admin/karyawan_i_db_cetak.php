...
$sql = mysqli_query($conn, "SELECT * FROM karyawan WHERE switch = 'off'");
?>
<!doctype html>
<html lang="en">
  <head>
...
<br>
       <p style="font-size: 20px; text-align: center;"><b>Database Inbox Karyawan</b></p>
<br>
<table class="table">
          <tr>
            <th>No</th>
         ...
         <tr>
           <td><?= $s; ?></td>
           <td><img src="../img/karyawan/<?=$sq["foto"];?>"width ="50px"></td>
           <td><?= $sq["karyawan"]; ?><br><?= $sq["jabatan"]; ?></td>
            <td><?= $sq["alamat"]; ?></td>
