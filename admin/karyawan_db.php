...
if(isset($_POST["search"])) {
      ...
      $sql = mysqli_query($conn, "SELECT * FROM karyawan WHERE switch ='on' ORDER BY id_karyawan asc LIMIT $mulai,$halaman"); 
      $sql2 = mysqli_num_rows($sql);
      $sq= mysqli_query($conn, "SELECT * FROM karyawan WHERE switch ='on'");
      $sql3 = mysqli_num_rows($sq);   
    }
  ...
  <body>
   ...
   <!-- -------------- -->
    <div class="form p-1">
      ...
      <span style="font-size: 20px">Database Karyawan [<a href="karyawan_i_db.php">Inbox</a>]</span>
        <span class="hidden float-right"><a href="karyawan_db_cetak.php" class="btn btn-outline-info btn-sm"><img src="../img/print.png"></a></span>
        <span class="hidden float-right"><a href="karyawan_add.php" class="btn btn-outline-info btn-sm"><img src="../img/add.png"></a></span> 
      <span class="float-right">
       ...
       <table class="table table-hover">
          ...
          <tr>
            ...
            <td class="text-center na"><a href="karyawan_edit.php?id=<?=$row["id_karyawan"]; ?>">O</a> | <a href="karyawan_delete.php?id=<?=$row["id_karyawan"]; ?>" onclick = "return confirm('yakin ?');">X</a><br><?=$row["status"]; ?></td>
          </tr>
        <?php $no++;?>
         <?php endwhile; ?>
      </table>
