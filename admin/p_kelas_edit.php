...
if(isset($_POST["submit"])){
 ...
 $query = "UPDATE kelas SET kelas = '$kelas' WHERE id_kelas = '$id'";
  ...
  if (mysqli_affected_rows($conn) > 0) {
    ...
    document.location.href = 'p_kelas_db.php';
    </script>
    ";
  } else {
    echo"
...
<html lang="en">
  ...
  <body>
   <div class="container">
    ...
    <!-- ------------ -->
  <div class="form">  
            <h3 style="margin: 0px">Edit Kelas</h3>
         <hr>
    ...
    <div class="row">
      <div class="col-md-7">
        <div class="form-group">
           ...
           <input type="text" name="kelas"  value="<?= $ex["kelas"]; ?>" class="form-control" id="kelas" autocomplete="off">
        </div>
      </div>
      </div>
<hr> 
    <input type="submit" name="submit" class="btn btn-outline-dark" value="Ubah"/>
<a href="p_kelas_db.php" class="btn btn-outline-dark">Cancel</a>
    </form>
