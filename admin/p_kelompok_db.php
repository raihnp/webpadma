...
<html lang="en">
  ...
  <div class="card-header">
   <span style="font-size: 20px">Database Pengelompokkan Kelas</span> <span class="hidden float-right"><a href="p_kelompok_add.php"><img src="../img/add.png"></a></span>
  </div>
          ...
          <tr>
            <td><?= $i; ?></td>
            <td><?=$sq["kelompok"]; ?></td>
            <td class="text-center"><a href="p_kelompok_edit.php?id=<?=$sq["id_kelompok"]; ?>">O</a> | <a href="p_kelompok_delete.php?id=<?=$sq["id_kelompok"]; ?>"onclick = "return confirm('yakin ?');">X</a></td>        
          </tr>
        <?php $i++;
        endwhile; ?>
        </table>
