...
$sql = mysqli_query($conn, "SELECT * FROM karyawan WHERE switch = 'on'");
?>
<!doctype html>
<html lang="en">
  <head>
...
<br>
       <p style="font-size: 20px; text-align: center;"><b>Database Pamong</b></p>
<br>
<table class="table">
          <tr>
            <th>No</th>
         ...
         <tr>
           ...
           <td><?= $sq["karyawan"]; ?><br><i><?= $sq["jabatan"]; ?></i></td>
           <td><?= $sq["alamat"]; ?></td>
