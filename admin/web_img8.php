...
if(isset($_POST["submit"])){
  ...
  $filefoto = $_FILES["filefoto"]["name"];
   ...
   $query = "UPDATE web SET img8 = '$foto', quote = '$quote', nama = '$nama', kap = '$kap' WHERE id_web ='1'";
...
<div class="col-md-10">
    ...
    <form method="POST" action="" enctype="multipart/form-data">
      <div class="form-group">
        <label for="ket" class="control-label">Quote</label>
      <textarea class="ckeditor" name="quote" class="form-control" ><?=$row["quote"]; ?></textarea>
    </div>
      <div class="row mt-2 pl-2">
      <div class="col-md-3">
          <img src="../img/web/<?=$row["img8"]; ?>" width = "200px"><br><i>Terpasang</i>
        </div>
      <div class="col-md-3">
        <div class="form-group">
          <i>Ganti</i>
           <input type="file" name="filefoto" value="" class="form-control" id="filefoto">
            <input type="hidden" name="fotolama" value="<?=$row["img8"]; ?>">
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          <i>Kaption</i>
        <input type="text" name="kap" value="<?=$row["kap"]; ?>" class="form-control">
      </div>
      </div>
    </div>
    <br>
