...
$query1 = "UPDATE guru SET kal = 'outline-success' WHERE id_guru = '$id_guru'";
   ...
   <div class="container">
    ...
    <div class="card p-1" style="width: 100%;">
      ...
      <span style="font-size: 20px">Database Kalender</span>
        <span class="hidden float-right"><a href="kalender_add.php" class="btn btn-outline-info btn-sm"><img src="../img/add.png"></a></span> 
 ...
 <table class="table table-hover">
        ...
        <?php while($row = mysqli_fetch_assoc($sql)) : ?>
          ...
          <tr>
            ...
            <td width="60px"><a href="kalender_edit.php?id=<?=$row["id_kalender"]; ?>">O</a> | <a href="kalender_delete.php?id=<?=$row["id_kalender"]; ?>"onclick = "return confirm('yakin ?');">X</a></td>
        <?php endwhile; ?>
      </tr>   
        </table> 
