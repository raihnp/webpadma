      ...
      <div class="col-md">
        ...
        <div class="card-header text-center">
          ...
          <table class="table">
            ...
            <tr>
              <td><?=$s; ?><div class="hidden"><br><a href="jadwal_edit.php?id=<?=$sen["id_jadwal"]; ?>">O</a></div></td>
        ...
        <div class="card-header text-center">
          ...
          <table class="table">
            ...
            <tr>              
              <td><?=$s; ?><div class="hidden"><br><a href="jadwal_edit.php?id=<?=$sel["id_jadwal"]; ?>">O</a></div></td>
        ...
        <div class="card-header text-center">
          ...
          <table class="table">
            ...
            <tr>
              <td><?=$s; ?><div class="hidden"><br><a href="jadwal_edit.php?id=<?=$rab["id_jadwal"]; ?>">O</a></div></td>
      ...
      <div class="col-md">
        ...
        <div class="card-header text-center">
          ...
          <table class="table">
            ...
            <tr>
              <td><?=$s; ?><div class="hidden"><br><a href="jadwal_edit.php?id=<?=$kam["id_jadwal"]; ?>">O</a></div></td>
        ...
        <div class="card-header text-center">
          ...
          <table class="table">
            ...
            <tr>
              <td><?=$s; ?><div class="hidden"><br><a href="jadwal_edit.php?id=<?=$jum["id_jadwal"]; ?>">O</a></div></td>
        ...
        <div class="card-header text-center">
          ...
          <table class="table">
            ...
            <tr>
              <td><?=$s; ?><div class="hidden"><br><a href="jadwal_edit.php?id=<?=$sap["id_jadwal"]; ?>">O</a></div></td>
