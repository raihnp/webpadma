...
<html lang="en">
  ...
  <div class="card-header">
   ...
   <span class="hidden float-right"><a href="p_exstra_db_cetak.php" class="btn btn-outline-info btn-sm"> <img src="../img/print.png"></a></span>
   <span class="float-right"><a href="p_exstra_add.php" class="btn btn-outline-info btn-sm"><img src="../img/add.png"></a></span>
  </div>
          ...
          <tr>
            ...
            <td><?=$sq["keterangan"]; ?></td>
            <td><?=$sq["tempat"]; ?></td>
            <td class="text-center"><a href="p_exstra_edit.php?id=<?=$sq["id_exstra"]; ?>">O</a> | <a href="p_exstra_delete.php?id=<?=$sq["id_exstra"]; ?>"onclick = "return confirm('yakin ?');">X</a></td>        
          </tr>
        <?php $i++;
        endwhile; ?>
        </table>
