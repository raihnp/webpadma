...
<html lang="en">
  ...
  <div class="card-header">
   <span style="font-size: 20px">Database Jabatan</span> <span class="hidden float-right"><a href="p_jabatan_add.php"><img src="../img/add.png"></a></span>
  </div>
          ...
          <tr>
            <td><?= $i; ?></td>
            <td><?=$sq["jabatan"]; ?></td>
            <td class="text-center"><a href="p_jabatan_edit.php?id=<?=$sq["id_jabatan"]; ?>">O</a> | <a href="p_jabatan_delete.php?id=<?=$sq["id_jabatan"]; ?>"onclick = "return confirm('yakin ?');">X</a></td>        
          </tr>
        <?php $i++;
        endwhile; ?>
        </table>
