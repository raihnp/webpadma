...
if(isset($_POST["search"])) {
      ...
      $sql = mysqli_query($conn, "SELECT * FROM alumni WHERE nis LIKE '%$keyword%' OR alumni LIKE '%$keyword%' OR kls LIKE  '%$keyword%' ORDER BY nis asc");
 ...
 <table class="table table-hover">
    ...
    <tr>
      ...
      <td class="d-inline-block align-top" style="text-align: center;">
        <img src="../img/alumni/<?=$row["foto"];?>"width ="50px"><br><?=$row["nis"];?></td>
      <td><?=$row["alumni"];?><br><i><?=$l;?></i></td>
      ...
      <td class="text-center na"><a href="alumni_edit.php?id=<?=$row["id_alumni"]; ?>">O</a></td>
    </tr>
   <?php endwhile; ?>
</table>
