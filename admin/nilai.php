...
if( isset($_POST["hapus"])){
  $deskripsi = $_POST["deskripsi"];
  $klass = $_POST["klass"];
  $query = "DELETE FROM nilai WHERE id_jadwal = '$klass' AND judul = '$deskripsi' AND guru = '$guru'";
...
<div class="col-md-10 mt-4">
    ...
    <div class="card p-1" style="width: 100%;">
        <div class="card-header" style="font-size: 14px;">
             <p style="font-size: 20px;"><b>Nilai Siswa</b></p>
        </div>
...
<!-- +++++++++++++++++++++++ -->
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <a href="javascript:history.back()" class="btn btn btn-outline-dark">Cancel</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;<input type="submit" name="hapus" class="btn btn-outline-danger" onclick = "return confirm('yakin ?');" value="Hapus" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;<input type="submit" name="cetak" class=" hidden btn btn-outline-secondary" value="Cetak"/>
      </div>
    </div>
    </form>
</div>
