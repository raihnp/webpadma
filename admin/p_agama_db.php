...
<html lang="en">
  ...
  <div class="card-header">
   <span style="font-size: 20px">Database Agama</span> <span class="hidden float-right"><a href="p_agama_add.php"><img src="../img/add.png"></a></span>
  </div>
          ...
          <tr>
            <td><?= $i; ?></td>
            <td><?=$sq["agama"]; ?></td>
            <td class="text-center"><a href="p_agama_edit.php?id=<?=$sq["id_agama"]; ?>">O</a> | <a href="p_agama_delete.php?id=<?=$sq["id_agama"]; ?>" onclick = "return confirm('yakin ?');">X</a></td>        
          </tr>
        <?php $i++;
        endwhile; ?>
        </table>
