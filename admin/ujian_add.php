...
if(isset($_POST["submit"])){
  ...
  $keterangan = $_POST["keterangan"];
    ...
    $query = "UPDATE siswa2 JOIN siswa1 ON siswa2.id_siswa = siswa1.id_siswa SET siswa2.ujian = 'success' WHERE siswa1.kls like '%$kls%'";
    mysqli_query($conn, $query);

    $query1 = "UPDATE guru SET ujian = 'success' WHERE id_guru = '$id_guru'";
