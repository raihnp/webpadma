...
if(isset($_POST["submit"])){
  ...
  $chat = '';
  $switch = "on";
        $query = "INSERT INTO guru VALUES ('', '$guru', '$code', '$kodeg', '$nip', '$nuptk', '$agama', '$jk', '$tempat', '$tanggal', '$alamat', '$telpon', '$email', '$line', '$jabatan', '$pelajaran', '$foto', '$status', '$kal', '$info', '$abs', '$nilai', '$ujian', '$tugas', '$untuk', '$chat', '$switch', '$catatan')";
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="form-group">
           ...
           <input type="text" name="guru"  class="form-control" id="guru" autocomplete="off">
        </div>
      </div>
      <div class="col-md-2">
        <div class="form-group">
           <label for="kodeg" class="control-label">Kode Guru</label>
           <input type="text" name="kodeg"  class="form-control" id="kodeg" autocomplete="off">
        </div>
      </div>
      <div class="col-md-2">
        <div class="form-group">
