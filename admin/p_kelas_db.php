...
<html lang="en">
  ...
  <div class="card-header">
   <span style="font-size: 20px">Database Kelas</span> <span class="hidden float-right"><a href="p_kelas_add.php"><img src="../img/add.png"></a></span>
  </div>
          ...
          <tr>
            <td><?= $i; ?></td>
            <td><?=$sq["kelas"]; ?></td>
            <td class="text-center"><a href="p_kelas_edit.php?id=<?=$sq["id_kelas"]; ?>">O</a> | <a href="p_kelas_delete.php?id=<?=$sq["id_kelas"]; ?>"onclick = "return confirm('yakin ?');">X</a></td>        
          </tr>
        <?php $i++;
        endwhile; ?>
        </table>
