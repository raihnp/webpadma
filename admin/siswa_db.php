...
if(isset($_POST["search"])) {
      ...
      $sql = mysqli_query($conn, "SELECT * FROM siswa WHERE switch = 'on' AND kls LIKE '%$keyword%' OR siswa LIKE '%$keyword%' OR nis LIKE '%$keyword%' ORDER BY nis asc");
  ...
  <body>
   ...
   <!-- -------------- -->
    <div class="form p-1">
      ...
      <span style="font-size: 20px">Database Siswa [<a href="siswa_i_db.php">Inbox</a>]</span>
        <span class="hidden float-right"><a href="siswa_db_cetak.php" class="btn btn-outline-info btn-sm"><img src="../img/print.png"></a></span>
        <span class="hidden float-right"><a href="siswa_add.php" class="btn btn-outline-info btn-sm"><img src="../img/add.png"></a></span> 
      <span class="float-right">
       ...
       <table class="table table-hover">
          ...
          <tr>
            ...
            <td class="text-center na"><a href="siswa_edit.php?id=<?=$row["id_siswa"]; ?>">O</a> | <a href="siswa_delete.php?id=<?=$row["id_siswa"]; ?>" onclick = "return confirm('yakin ?');">X</a><br><?=$row["status"]; ?><br><a href="ortu_cab.php?nis=<?=$row["nis"]; ?>&nama=<?=$row["siswa"]; ?>&kls=<?=$k; ?>">Ortu</a>
            </td>
          </tr>
        <?php $no++;?>
         <?php endwhile; ?>
