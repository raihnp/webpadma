...
$sql = mysqli_query($conn, "SELECT * FROM periode");
?>
<!doctype html>
<html lang="en">
  <head>
  ...
  <div class="card-header">
   <span style="font-size: 20px">Database Periode</span> <span class="hidden float-right"><a href="p_periode_add.php"><img src="../img/add.png"></a></span>
  </div>
          ...
          <tr>
            ...
            <td><?=$sq["periode"]; ?></td>
            <td><?=$sq["jam"]; ?></td>
            <td class="text-center"><a href="p_periode_edit.php?id=<?=$sq["id_periode"]; ?>">O</a> | <a href="p_periode_delete.php?id=<?=$sq["id_periode"];?>"onclick = "return confirm('yakin ?');">X</a></td>        
          </tr>
        <?php $i++;
        endwhile; ?>
        </table>
