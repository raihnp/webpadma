...
$sql = mysqli_query($conn, "SELECT * FROM pelajaran ORDER BY pelajaran ASC");
?>
<!doctype html>
<html lang="en">
  <head>
  ...
  <div class="card-header">
   <span style="font-size: 20px">Database Pelajaran</span> <span class="hidden float-right"><a href="p_pelajaran_add.php"><img src="../img/add.png"></a></span>
  </div>
          ...
          <tr>
            <td><?= $i; ?></td>
            <td><?=$sq["pelajaran"]; ?></td>
            <td class="text-center"><a href="p_pelajaran_edit.php?id=<?=$sq["id_pelajaran"]; ?>">O</a> | <a href="p_pelajaran_delete.php?id=<?=$sq["id_pelajaran"];?>"onclick = "return confirm('yakin ?');">X</a></td>        
          </tr>
        <?php $i++;
        endwhile; ?>
        </table>
