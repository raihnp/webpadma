          ...
          if($ukuran < 500000){
           ...
           $move = move_uploaded_file($foto_tmp, '../img/ortu/'.$filefotoBaru);
              if($move){$foto = $filefotoBaru; 
                ...
                document.location.href = 'ortu_db.php';</script>";}
        }else{echo"<script>
              alert('Data gagal ditambahkan ... Ekstensi Foto yang diperbolehkan png dan jpg');
              document.location.href = 'ortu_db.php';</script>";}
        $query = "INSERT INTO ortu VALUES ('', '$ortu', '$nis', '$tempat', '$tanggal', '$jk', '$ktp', '$agama', '$alamat', '$telpon', '$email', '$line', '$foto', '$catatan', '$switch', '$ujian', '$tugas', '$nilai', '$info', '$kal', '$tu', '$perpus')";
...
<html lang="en">
  ...
  <body>
   ...
   <!-- -------------- -->
   <div class="form">  
            <h4 style="margin: 0px">FORM Orang Tua/ Wali</h4>
         <hr>
    ...
    <div class="row">
      <div class="col-md-9">
        <div class="form-group">
           ...
           <input type="text" name="ortu"  class="form-control" id="ortu" autocomplete="off" required>
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-md-2">
        <div class="form-group">
           ...
           <input type="text" name="tanggal" class="form-control" placeholder="hh-bb-yyyy" id="tanggal" autocomplete="off">
        </div>
      </div> 
      <div class="col-md-3">
        <div class="form-group">
      ...
      <div class="col-md-12">
        <div class="form-group">
           ...
           <input type="textarea" name="alamat"  class="form-control" id="alamat" autocomplete="off">
        </div>
      </div>
    </div>
    <div class="row">
