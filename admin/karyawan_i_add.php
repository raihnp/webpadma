       ...
       if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
          if($ukuran < 500000){
           ...
           $move = move_uploaded_file($foto_tmp, '../img/karyawan/'.$filefotoBaru);
              ...
              document.location.href = 'karyawan_db.php';</script>";}
        $query = "INSERT INTO karyawan VALUES ('', '$karyawan', '$code', '$nik', '$agama', '$jk', '$tempat', '$tanggal', '$alamat', '$telpon', '$email', '$line', '$jabatan', '$foto', '$status', '$kal', '$info', '$abs', '$switch', '$catatan')";
...
<html lang="en">
  ...
  <body>
   ...
   <!-- -------------- -->
   <div class="form">  
            <h3 style="margin: 0px">FORM Karyawan off</h3>
         <hr>
