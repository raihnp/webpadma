   ...
   <div class="container">
    ...
    <div class="form p-1">
      ...
      <div class="row clear">
          ...
          <div class="kotak text-center"><a href="p_jadwal_add.php?kelas=<?=$row["kelas"]; ?>"><b><?=$row["kelas"]; ?></b></a></div>
          <?php endwhile; ?>
    </div>
  </div>
</div>
           ...
           <div class='panel panel-default p-1 mt-1'>
            <div class="panel-heading">
              ...
              <table class="table">
                 ...
                 <tr>
                  <td><i><?=$sen["guru1"]; ?><br><?=$sen["guru2"]; ?><br><?=$sen["guru3"]; ?><br><?=$sen["guru4"]; ?><br><?=$sen["guru5"]; ?></i></td>
                  <td class="text-center"><a href="piket_edit.php?id=<?=$sen["id_piket"]; ?>">O</a></td>
                 </tr>
               </table>
          </div>
        </div>
           ...
           <div class='panel panel-default p-1 mt-1'>
            <div class="panel-heading">
              ...
              <table class="table">
                ...
                <tr>
                  <td><i><?=$sel["guru1"]; ?><br><?=$sel["guru2"]; ?><br><?=$sel["guru3"]; ?><br><?=$sel["guru4"]; ?><br><?=$sel["guru5"]; ?></i></td>
                  <td  class="text-center"><a href="piket_edit.php?id=<?=$sel["id_piket"]; ?>">O</a></td>
                </tr>
              </table>
            </div>
        </div>
           ...
           <div class='panel panel-default p-1 mt-1'>
            <div class="panel-heading">
              ...
              <table class="table">
                ...
                <tr>
                 <td><i><?=$rab["guru1"]; ?><br><?=$rab["guru2"]; ?><br><?=$rab["guru3"]; ?><br><?=$rab["guru4"]; ?><br><?=$rab["guru5"]; ?></i></td>
                 <td  class="text-center"><a href="piket_edit.php?id=<?=$rab["id_piket"]; ?>">O</a></td>
                </tr>
              </table>
           </div>
        </div>
          ...
          <div class='panel panel-default p-1 mt-1'>
            ...
            <p class="text-center m-0"><b>KAMIS</b></p>
                  ...
                  <table class="table">
                    ...
                    <tr>
                      <td><i><?=$kam["guru1"]; ?><br><?=$kam["guru2"]; ?><br><?=$kam["guru3"]; ?><br><?=$kam["guru4"]; ?></i><br><?=$kam["guru5"]; ?></td>
                      <td class="text-center"><a href="piket_edit.php?id=<?=$kam["id_piket"]; ?>">O</a></td>
                    </tr>
                  </table>
          </div>
        </div>
            ...
            <div class="panel-heading">
              <p class="text-center m-0"><b>JUMAT</b></p>
                  ...
                  <table class="table">
                    ...
                    <tr>
                      <td><i><?=$jum["guru1"]; ?><br><?=$jum["guru2"]; ?><br><?=$jum["guru3"]; ?><br><?=$jum["guru4"]; ?><br><?=$jum["guru5"]; ?></i></td>
                      <td class="text-center"><a href="piket_edit.php?id=<?=$jum["id_piket"]; ?>">O</a></td>
                    </tr>
                  </table>
            </div>
        </div>
            ...
            <div class="panel-heading">
              <p class="text-center m-0"><b>SAPTU</b></p>
                  ...
                  <table class="table">
                    ...
                    <tr>
                      <td><i><?=$sap["guru1"]; ?><br><?=$sap["guru2"]; ?><br><?=$sap["guru3"]; ?><br><?=$sap["guru4"]; ?><br><?=$sap["guru5"]; ?></i></td>
                      <td class=" "><a href="piket_edit.php?id=<?=$sap["id_piket"]; ?>">O</a></td>
                    </tr>
                  </table>
            </div>
        </div>
