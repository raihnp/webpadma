...
$query = mysqli_query($conn,"SELECT img4, vid4 FROM web");
...
if(isset($_POST["submit"])){
  ...
  $filefoto = $_FILES["filefoto"]["name"];
   ...
   $query = "UPDATE web SET img4 = '$foto', vid4 = '$vid4' WHERE id_web ='1'";
    ...
    <div class="form p-1">
      ...
      <form method="POST" action="" enctype="multipart/form-data">
          <div class="row mt-2 pl-2">
            <div class="col-md-4">
                <img src="../img/web/<?=$row["img4"]; ?>" width = "200px"><br><i>Terpasang</i>
            </div>
            <div class="col-md-8">
              <div class="form-group">
                <i>Ganti Gambar</i>
                 <input type="file" name="filefoto" value="" class="form-control" id="filefoto">
                  <input type="hidden" name="fotolama" value="<?=$row["img4"]; ?>">
              </div>
            </div>
          </div>
        <div class="row">
          ...
          <div class="form-group">
            <i>Ganti Video</i>
             <div class="form-group">
              <textarea  name="vid4" id="ket" class="form-control" ><?=$row["vid4"]; ?></textarea>
            </div>
          </div>
        </div>
        </div>
