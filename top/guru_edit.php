...
if(isset($_POST["submit"])){
  ...
  $filefoto = $_FILES["filefoto"]["name"];
        ...
        if($ukuran < 500000){
         ...
         $move = move_uploaded_file($foto_tmp, '../img/guru/'.$filefotoBaru);
          if($move){
            ...
            {
            echo ("Deleted ../img/guru/$fotolama");
            echo "<META HTTP-EQUIV=Refresh CONTENT='1; URL=guru_db.php'>";
            }
                $foto =$filefotoBaru;
          }else{
            echo"
   ...
   $query = "UPDATE guru SET guru = '$guru', code = '$code', nip = '$nip', nuptk = '$nuptk', agama = '$agama', jk = '$jk', tempat = '$tempat', tanggal ='$tanggal', alamat = '$alamat',telpon = '$telpon', email = '$email',line = '$line', jabatan = '$jabatan', pelajaran =  '$pelajaran', foto = '$foto', catatan = '$catatan' WHERE id_guru = '$id'";
...
$pelajaran = mysqli_query($conn, "SELECT pelajaran FROM pelajaran ORDER BY pelajaran ASC");
    ...
    <div class="row">
      <div class="col-md-7">
        <div class="form-group">
           ...
           <input type="text" name="guru" value="<?=$row["guru"]; ?>" class="form-control" id="guru">
        </div>
      ...
      <div class="col-md-3">
        <div class="form-group">
           ...
           <input type="text" name="nip" value="<?=$row["nip"]; ?>" class="form-control" id="nip">
        </div>
      </div>
      </div> 
      <div class="row">        
       <div class="col-md-3">
        <div class="form-group">
           ...
           <input type="text" name="nuptk" value="<?=$row["nuptk"]; ?>" class="form-control" id="nuptk">
        </div>
      </div>    
        <div class="col-md-3">
        <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        <div class="form-group">
           ...
           <input type="textarea" name="alamat" value="<?=$row["alamat"]; ?>" class="form-control" id="ala_guru">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
           ...
           <input type="text" name="telpon" value="<?=$row["telpon"]; ?>" class="form-control" id="tel_guru">
        </div>
      </div>
      <div class="col-md-4">
        <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="form-group">
           ...
           <select name="pelajaran" class="form-control" id="pel">
            ...
            <?php while($aja = mysqli_fetch_assoc($pelajaran)): ?>
