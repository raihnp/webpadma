          ...
          if($move){
            ...
            { "Deleted ../img/siswa/$fotolama";
              "<META HTTP-EQUIV=Refresh CONTENT='1; URL=siswa_db.php'>";
                      ...
                      document.location.href = 'siswa_i_db.php';
                      </script>"; return false;}
        }else{echo"<script>
...
<html lang="en">
  ...
  <body>
            ...
            <div class="card-header text-center">
             <?= $jabatanx; ?>
              ...
              <ul>
                ...
                <li><a href="siswa_i_db.php">InboxDb</a></li>
              </ul>
          </div>
        </div>
      </div>
   ...
   <!-- -------------- -->
   <div class="form">  
            <h3 style="margin: 0px">FORM Edit Siswa Inbox</h3>
         <hr>
...
<a href="siswa_i_db.php" class="btn btn-outline-dark">Cancel</a>
    </form>
  </div>
     </div>
   </div>
