...
$sqll = mysqli_query($conn, "SELECT * FROM pass WHERE id_karyawan = '$id'");
$sqq = mysqli_fetch_assoc($sqll);
if(isset($_POST["submit"])){
  $level = $_POST["level"];
  $query = "UPDATE pass SET level = '$level' WHERE id_karyawan = '$id'";
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
           ...
           <input type="text" name="" value="<?=$sq["karyawan"]; ?>" class="form-control" id="user" disabled>
        </div>
      </div> 
       <div class="col-md-4">
        <div class="form-group">
