...
if(isset($_POST["submit"])){
  ...
  $chat = " ";
  $switch = "on";
        $query = "INSERT INTO guru VALUES ('', '$guru', '$code', '$nip', '$nuptk', '$agama', '$jk', '$tempat', '$tanggal', '$alamat', '$telpon', '$email', '$line', '$jabatan', '$pelajaran', '$foto', '$status', '$kal', '$info', '$abs', '$nilai', '$ujian', '$tugas', '$masuk', '$chat', '$switch', '$catatan')";
