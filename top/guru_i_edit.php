 ...
 $fotolama = $_POST["fotolama"];
  ...
  $filefoto = $_FILES["filefoto"]["name"];
      ...
      if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
        ...
        $query = "UPDATE guru SET guru = '$guru', nip = '$nip', nuptk = '$nuptk', agama = '$agama', jk = '$jk', tempat = '$tempat', tanggal = '$tanggal', alamat = '$alamat', telpon = '$telpon', email = '$email', line = '$line', jabatan = '$jabatan', pelajaran = '$pelajaran', foto = '$foto', catatan = '$catatan' WHERE id_guru = '$id'";
  ...
  <body>
   ...
   <div class="form">  
    ...
    <div class="row">
      <div class="col-md-9">
        <div class="form-group">
           ...
           <input type="text" name="guru"  class="form-control" id="guru" value="<?=$row['guru'];?>" autocomplete="off" required>
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
           <label for="nip" class="control-label">NIP</label>
           <input type="text" name="nip"  class="form-control" id="nip" value="<?=$row['nip'];?>" autocomplete="off">
        </div>
      </div> 
    </div>
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
           ...
           <input type="text" name="nuptk"  class="form-control" id="nuptk" value="<?=$row['nuptk'];?>" autocomplete="off">
        </div>
      </div>
      <div class="col-md-2">
        <div class="form-group">
    ...
    <div class="row">    
      <div class="col-md-6">
        <div class="form-group">
           <label for="jabat" class="control-label">Jabatan Terakhir</label>
      ...
      <div class="col-md-6">
        <div class="form-group">
           <label for="pel" class="control-label">Mata Pelajaran Terakhir yang diampu</label>
