...
if(isset($_POST["search"])) {
      ...
      $sql = mysqli_query($conn, "SELECT * FROM guru WHERE switch = 'on' AND kodeg LIKE '%$keyword%' OR guru LIKE '%$keyword%' OR jabatan LIKE  '%$keyword%'OR pelajaran LIKE '%$keyword%' ORDER BY code asc");
       ...
       <table class="table table-hover">
          ...
          <tr>
            ...
            <td class="na">
             ...
             <td class="na"><a href="guru_aktif.php?id=<?=$row["id_guru"]; ?>"><?=$row["status"]; ?></a><br><a href="guru_reset.php?id=<?=$row["id_guru"]; ?>" onclick = "return confirm('yakin ?');">Reset</a><br><a href="guru_level.php?id=<?=$row["id_guru"]; ?>">Level</a></td>
             <td class="na"><a href="guru_edit.php?id=<?=$row["id_guru"];?>">O</a> | <a href="guru_delete.php?id=<?=$row["id_guru"];?>"  onclick = "return confirm('yakin ?');">X</a><br><a href="jadwal_guru.php?id=<?=$row["guru"];?>">Jadwal</a></td>
          </tr>
         <?php endwhile; ?>
      </table>
