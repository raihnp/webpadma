  ...
  <body>
   <div class="container">
    ...
    <div class="form p-1">
      ...
      <span style="font-size: 20px">Database Karyawan [<a href="karyawan_db.php">Reset</a>]</span>
      ...
      <span class="float-right">
       ...
       <table class="table table-hover">
          <tr>
            ...
            <th class="hidden"></th>
            <th class="hidden"><img src="../img/setting.png"></th>
          ...
          <tr>
            ...
            <td class="hidden">
             ...
             <td class="hidden"><a href="karyawan_i_edit.php?id=<?=$row["id_karyawan"];?>">O</a></td>
          </tr>
        <?php $no++;?>
         <?php endwhile; ?>
      </table>
