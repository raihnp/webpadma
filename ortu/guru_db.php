...
if(isset($_POST["search"])) {
      ...
      $sql = mysqli_query($conn, "SELECT * FROM guru WHERE code LIKE '%$keyword%' OR guru LIKE '%$keyword%' OR jabatan LIKE  '%$keyword%'OR pelajaran LIKE '%$keyword%'ORDER BY id_guru asc");
      ...
      <div class="card p-1" style="width: 100%;">
       ...
       <table class="table table-hover">
          ...
          <tr>
            ...
            <td class=""><?=$row["guru"];?><br><i><?=$row["jabatan"];?><br><?=$row["pelajaran"];?></i></td>
