...
$sqly = mysqli_query($conn, "SELECT * FROM siswa WHERE switch = 'on' AND nis = '$nis' ");
...
$sis = mysqli_query($conn,"SELECT * FROM ortu WHERE switch = 'on' AND id_ortu = '$id_ortu'");
$s2 = mysqli_fetch_assoc($sis);
...
<p style="font-size: 20px;"><a href="exstra.php">Ekstra Kurikuler</a> yang anda ikuti :</p>
<p style="font-size: 18px;"><i><?= $ek["pilih"];?></i></p>
   <!-- -------------- -->
</div>
