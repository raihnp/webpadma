...
if(isset($_POST["search"])) {
      ...
      $sql = mysqli_query($conn, "SELECT * FROM keluar WHERE ortu = 'Ortu' ORDER BY id_keluar DESC LIMIT $mulai,$halaman"); 
      $sql2 = mysqli_num_rows($sql);
      $sq= mysqli_query($conn, "SELECT * FROM keluar ");
      $sql3 = mysqli_num_rows($sq);   
    }
    $akhir = ceil($sql3/$halaman);
    $query = "UPDATE siswa SET info = 'outline-primary' WHERE nis = '$nis'";
